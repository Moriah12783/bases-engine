...
- Présentation (retour mentor sur la répétition du 21/09) : paris réels, structure dans le pari, sélection moteur + associés, ordre Quinté+ puis A/B/C, libellés k/k, bloc abstentions FR, légende. Ajout au-delà de la règle (à signaler) : courses sans Quarté+/Multi **ni 2sur4** (petits pelotons, Trio + Couplé placé seulement) → « Trio avec les 2 bases + X », barreau 2.
