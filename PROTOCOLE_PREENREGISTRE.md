...
- **25/09/2026, 11:05 UTC** : première passe planifiée sur R2 (frappe du métronome, base sha256 `5be9a27fd7e1` poussée à 11:01:51 UTC) : **journée partielle, 15 éditions** (41 courses lues ; 26 abstentions dont 10 départs passés ou à moins de 20 minutes). Le 25/09 n'est donc pas une journée perdue ; aucune journée perdue à ce jour, verdict inchangé au 20/10/2026.
...
- **Source de la publication réelle du moteur** : demandée le 25/09/2026 au développeur Radar, propriétaire de la porte, sous forme d'une table en ajout seul dans la base R2 (une ligne par course et par horizon, avec `gate_version`) ; nom définitif annoncé par ligne datée, jamais supposé. Aucune lecture de la page d'accueil de prono.elite-turf.fr. Tant qu'elle manque, le soir écrit « comparaison de porte non disponible » au journal.
- **Basculement prévu** (consigné ici comme changement externe le jour venu, paramètres gelés inchangés) : l'éligibilité lira la décision T_MATIN enregistrée ; la porte reconstituée tournera quelques jours en parallèle comme contrôle de parité, écarts consignés, puis passera en retrait. Tout changement de `gate_version` déclenchera l'annotation et cette procédure.
